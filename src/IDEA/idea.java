...
public class idea {
	...
	public static String Cryptage(String message, String key)
	{
		...
		for(int i = 0; i < 8; i++)
		{
			...
			*/
			...
			//System.out.println("Round " + i + " " + b1 + b2 + b3 + b4);
		}
	...
	public static String Dechiffrement(String message, String key)
	{
		...
		for(int i = 0; i < 8; i++)
		{
			...
			String KD2 = Util.CalculSomme(parameters.otherKeys.get((8 * 6 + 1) - i * 6));
			...
			String KD5 = parameters.otherKeys.get((8 * 6 - 2) - i * 6);
			String KD6 = parameters.otherKeys.get((8 * 6 - 1) - i * 6);
		...
		String KD1 = Util.CalculInverseBinaire(parameters.otherKeys.get(0));
		String KD2 = parameters.otherKeys.get(1);
		String KD3 = Util.CalculSomme(parameters.otherKeys.get(2));
		String KD4 = Util.CalculInverseBinaire(parameters.otherKeys.get(3));
